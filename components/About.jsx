                                        ...
                                        <div className="absolute inset-0 px-4 sm:px-6 text-gray-200 flex xs:flex-col">
                                            ...
                                            <div className="pl-5 xs:pb-10 ">
                                                <div className="mb-8">
                                                    ...
                                                    <p className="pl-5 text-sm">Quickly after finishing my undergrad in Finance and Economics at Boulder I was searching for something more creative, combined with the analytical challenge of being given data and creating an impactful result. After finishing a bootcamp I can confidently say that software engineering is exactly the role I was looking for and learning the skills to materialize any creative idea is what excites me most.</p>
                                                </div>
                                                <div className="mb-8">
                                                    <p className="font-semibold text-gray-100 uppercase tracking-widest text-xl mb-2">Goals</p>
                                                    <p className="pl-5 text-sm">After becoming versed in MERN, Python, and Java - I am striving to continue expanding my expertise in those stacks and reinforcing a comprehensive understanding of computer science/development topics in general. To do so I am taking extra courses through Coursera/freeCodeCamp, working on personal projects, and completing Leetcode algorithms daily. I hope to eventually contribute to innovative technologies in a realm such as ML/AI/NLP, BMI's, blockchain, AR/VR, or global security.</p>
                                                </div>
                                                <div>
                                                    <p className="font-semibold text-gray-100 uppercase tracking-widest text-xl mb-2">Besides coding</p>
                                                    <p className="pl-5 text-sm">Having been a rugby player throughout my life, I enjoy staying active and being outdoors as much as I can: whether thats skiing, weightlifting, cycling, yoga, swimming, or something similar. I enjoy reading and occasionally drawing or journaling to wind down.  </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
